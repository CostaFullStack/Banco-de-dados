...
INSERT INTO livros (titulo, genero, ano_lanc, id_autor, qtde_paginas) 
    VALUES
...
INSERT INTO emprestimos (id_cliente, id_livro, data_emprestimo)
    VALUES
        (1, 1, '2023-01-15'), -- Empréstimo associado à cliente Maria Silva (O Assassinato no Expresso Oriente)
        (3, 3, '2023-03-12'), -- Empréstimo associado à cliente Ana Souza (Norwegian Wood)
        (6, 6, '2023-06-08'), -- Empréstimo associado ao cliente Rafael Pereira (O Senhor dos Anéis: As Duas Torres)
        (7, 7, '2023-07-17'), -- Empréstimo associado à cliente Carolina Almeida (1984)
        (7, 8, '2023-07-25'), -- Empréstimo associado à cliente Carolina Almeida (1984: New World)
        (9, 9, '2023-09-14'), -- Empréstimo associado à cliente Juliana Fernandes (Bons Augúrios)
        (10, 10, '2023-10-30'); -- Empréstimo associado ao cliente Lucas Carvalho (O Lobo da Estepe)
